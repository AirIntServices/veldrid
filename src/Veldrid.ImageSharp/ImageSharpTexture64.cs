...
{
    public class ImageSharpTexture64
    {
        /// <summary>
        ...
        /// </summary>
        public Image<Rgba64>[] Images { get; }
        ...
        public ImageSharpTexture64(string path) : this(Image.Load<Rgba64>(path), true) { }
        public ImageSharpTexture64(string path, bool mipmap) : this(Image.Load<Rgba64>(path), mipmap) { }
        public ImageSharpTexture64(string path, bool mipmap, bool srgb) : this(Image.Load<Rgba64>(path), mipmap, srgb) { }
        public ImageSharpTexture64(Stream stream) : this(Image.Load<Rgba64>(stream), true) { }
        public ImageSharpTexture64(Stream stream, bool mipmap) : this(Image.Load<Rgba64>(stream), mipmap) { }
        public ImageSharpTexture64(Stream stream, bool mipmap, bool srgb) : this(Image.Load<Rgba64>(stream), mipmap, srgb) { }
        public ImageSharpTexture64(Image<Rgba64> image, bool mipmap = true) : this(image, mipmap, false) { }
        public ImageSharpTexture64(Image<Rgba64> image, bool mipmap, bool srgb)
        {
        ...
        private unsafe Texture CreateTextureViaStaging(GraphicsDevice gd, ResourceFactory factory)
        {
            ...
            {
                Image<Rgba64> image = Images[level];
